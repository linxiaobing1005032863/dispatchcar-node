var app = angular.module('finchangecar', ['ng-pagination','toastr']);
app.controller('finchangecarCtrl',function($scope,finSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        finSer.changeCar(listData).then(function(response){
...
//分页
  ...
  /*  finSer.Countwait().then(function(response){
        if(response.data.code==0){
