var app = angular.module('finList', ['ng-pagination','toastr']);
app.controller('finListCtrl',function($scope,finSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        finSer.finList(listData).then(function(response){
...
//分页
    ...
    finSer.Countfin().then(function(response){
        if(response.data.code==0){
