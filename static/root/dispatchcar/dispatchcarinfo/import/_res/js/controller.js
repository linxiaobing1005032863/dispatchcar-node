var app = angular.module('infoimport', ['toastr']);
app.controller('infoimportCtrl', function($scope, infoSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/dispatchcarinfo/templateExport');
    };
    //删除文件
