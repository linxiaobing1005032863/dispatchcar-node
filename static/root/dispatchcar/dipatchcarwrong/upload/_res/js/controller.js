var app = angular.module('wrongUpload', ['toastr']);
app.controller('wrongUploadCtrl', function ($scope, wrongSer, $state, toastr, $http, $stateParams) {
