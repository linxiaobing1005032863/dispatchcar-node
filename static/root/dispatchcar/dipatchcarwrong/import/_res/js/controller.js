var app = angular.module('wrongimport', ['toastr']);
app.controller('wrongimportCtrl', function($scope, wrongSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/dipatchcarwrong/templateExport');
    };
    //删除文件
