var app = angular.module('payprincipalsugg', ['toastr']);
app.controller('payprincipalsuggCtrl', function($scope, paySer,$stateParams,$state,toastr){
...
$scope.infoEditFun = function() {
    ...
    paySer.paySugg(data).then(function (response) {
        if(response.data.code == 0){
