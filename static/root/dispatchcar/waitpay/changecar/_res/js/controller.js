var app = angular.module('changecarM', ['ng-pagination','toastr']);
app.controller('changecarCtrl',function($scope,paySer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        paySer.changeCar(listData).then(function(response){
...
//分页
    ...
    paySer.Countwait().then(function(response){
        if(response.data.code==0){
