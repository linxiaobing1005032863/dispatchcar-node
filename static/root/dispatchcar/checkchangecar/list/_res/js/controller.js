var app = angular.module('changeList', ['ng-pagination','toastr']);
app.controller('changeListCtrl',function($scope,changeSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        changeSer.changeList(listData).then(function(response){
