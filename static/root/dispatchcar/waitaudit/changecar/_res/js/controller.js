var app = angular.module('waitchangecar', ['ng-pagination','toastr']);
app.controller('waitchangecarCtrl',function($scope,waitSer,toastr,$stateParams,$state,$location){
    ...
    function activatePage(page) {
        ...
        waitSer.changeCar(listData).then(function(response){
